...
- Перед каждым запросом маршрута и перед чтением результата стоит пауза 0.5 секунды, чтобы не дергать Яндекс.Карты слишком быстро.
- Результат маршрута ожидается максимум 2 секунды. Если время не появилось, скрипт пишет `время не найдено` и идет дальше.
...
- В панели показывается примерное оставшееся время до завершения всех маршрутов.
